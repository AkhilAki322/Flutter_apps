                      ...
                      Row(
                        ...
                        children: <Widget>[
                          RaisedButton(
                            ...
                            onPressed: () async{
                              var employees1;
                              var yyy = dbHelper.retrival(name);
                              await yyy.then((asd) {
                                employees1 = asd;
                              });
                              var ff =Note(employees1[0]['id'], employees1[0]['name'], employees1[0]['name'], employees1[0]['name'], employees1[0]['name'], employees1[0]['name'], employees1[0]['name'], employees1[0]['name'], 'Given');
                              dbHelper.update(ff);
                            },
